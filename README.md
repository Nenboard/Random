...
Сжатый вариант программы всего в две строки ⬇:
#include <stdlib.h>
int main(){ int var{}; int seed = (int)&var; srand(seed); int random = rand(); }

Чтобы вывести случайное число в консоль ⬇:
#include <stdlib.h>
#include <stdio.h>
...
✔ Вывод: на выходе в конце выполнения программы мы получаем случайное число в переменной random. Программа уместилась всего в 9 строк. Остались вопросы или я допустил ошибку? Пишите в комментариях! ⬇
